...
;
;
// Your API URL (Express backend)
const API_URL = 'http://localhost:4000/api/tasks';
const useTasks = ()=>{
    // 1. Initial state: empty array of tasks
    ...
    // 2. FETCH LOGIC: Get tasks from API instead of localStorage
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$task$2d$manager$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchTasks = async ()=>{
            ...
            // Optional: add fallback or error notification here
            } finally{
                setIsLoading(false);
            }
        };
    ...
    // 3. CRUD functions: We'll modify them later to call the API
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c9dea692._.js.map