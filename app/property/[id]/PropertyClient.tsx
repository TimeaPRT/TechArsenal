...
export default function PropertyClient({ property }: { property: any }) {
  ...
  const handleShare = () => {
    ...
    alert("Property link has been copied to clipboard");
  };
            ...
            <div>
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button 
                    onClick={handleShare}
                    className="flex items-center gap-2 px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-200"
                  >
                    {/* Share2 SVG */}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 border rounded-md transition duration-200 ${
                      isFavorite 
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4m16 0v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6m16 0l-4-4m4 4l-4 4" />
                  </svg>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-200">
                  {/* Mail SVG */}
                  <svg className="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
